...
function getPanelImage(item, index) {
  return item.image || moduleImages[item.title] || fallbackImages[index % fallbackImages.length];
}
              ...
              <div className="absolute inset-0 overflow-hidden rounded-[24px]">
                <div
                  ...
                  style={{
                    ...
                    filter: isActive ? "grayscale(0) brightness(1)" : "grayscale(0.4) brightness(0.55)",
                    transform: isActive ? "scale(1) translateZ(0)" : "scale(1.04) translateZ(0)",
                  }}
                />
